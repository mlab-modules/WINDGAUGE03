...
R03_narrow_D = R03_wide_D/1.7; // Venturi narrow tube inner diameter
...
R03_sensor_housing_offset = 15;  // distance from venturi tube height to sensor housing drop
...
R03_wall_thickness = 5; // Venturi tube wall thickness
R03_sealing_ring_thickness = 1.5; // sealing ring size
R03_fin_width = 0.8; // width of vertical stabilizator
R03_fin_length = 80; // length of vertical stabilizator
