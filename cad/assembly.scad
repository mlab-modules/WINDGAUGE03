...
// R03 COG
translate([ 0.06938499999999692 , 5.1476399999999956 , 194.74700799999997 ])
    color([0, 1, 1]) sphere(3);
// R04 COG
translate([ 0.10551200000000449 , 37.93897 , 228.743815 ])
    color([0, 1, 1]) sphere(3);
// R05 COG
translate([ -0.4787259999999988 , -101.19676100000001 , 198.00737800000002 ])
    color([0, 1, 1]) sphere(3);
// R04 Left Bolt COG
...
// WINDGAUGE03_R* COG
translate([ 0.03750900705580294 , -0.8172311757536923 , 198.44113331751117 ])
